...
export type ProjectionFunc<T extends unknown[] = unknown[]> = (
	done: (...values: unknown[]) => void,
) => (...args: T) => void
...
const nodeDefs$$ = new Map<
	symbol,
	// biome-ignore lint:
	CellDefinition<any> | SignalDefinition<any>
>()
...
export class Realm {
	...
	private readonly singletonSubscriptions = new Map<
		symbol,
	...
	cellInstance<T>(
		...
		if (distinct !== false && !this.distinctNodes.has(node)) {
			this.distinctNodes.set(
				node,
				distinct === true
					? defaultComparator
					: (distinct as Comparator<unknown>),
			)
		}
	...
	singletonSub<T>(
		...
		if (subscription === undefined) {
			...
			this.singletonSubscriptions.set(
				node,
				...
				for (const { sources, sink } of projections) {
					if (sources.has(key)) {
						refCount.decrement(sink, () => {
							participatingNodeKeys.splice(
								participatingNodeKeys.indexOf(sink),
								1,
							)
			...
			if (Object.prototype.hasOwnProperty.call(values, id)) {
				...
				map.projections.use(id, (nodeProjections) => {
					for (const projection of nodeProjections) {
						const args = [
							...Array.from(projection.sources),
							...Array.from(projection.pulls),
						].map((id) => transientState.get(id))
	...
	): NodeRef<O3> // prettier-ignore
	pipe<T, O1, O2, O3, O4>(
		s: NodeRef<T>,
		...o: [O<T, O1>, O<O1, O2>, O<O2, O3>, O<O3, O4>]
	): NodeRef<O4> // prettier-ignore
	pipe<T, O1, O2, O3, O4, O5>(
		s: NodeRef<T>,
		...o: [O<T, O1>, O<O1, O2>, O<O2, O3>, O<O3, O4>, O<O4, O5>]
	): NodeRef<O5> // prettier-ignore
	pipe<T, O1, O2, O3, O4, O5, O6>(
		s: NodeRef<T>,
	...
	pipe<T>(
		source: NodeRef<T>,
		...operators: Array<O<unknown, unknown>>
	): NodeRef<unknown>
	pipe<T>(
		source: NodeRef<T>,
		...operators: Array<O<unknown, unknown>>
	...
	transformer<In, Out, O1>(
		...o: [O<In, O1>, O<O1, Out>]
	): (s: NodeRef<Out>) => NodeRef<In> // prettier-ignore
	transformer<In, Out, O1, O2>(
		...o: [O<In, O1>, O<O1, O2>, O<O2, Out>]
	): (s: NodeRef<Out>) => NodeRef<In> // prettier-ignore
	transformer<In, Out, O1, O2, O3>(
		...o: [O<In, O1>, O<O1, O2>, O<O2, O3>, O<O3, Out>]
	): (s: NodeRef<Out>) => NodeRef<In> // prettier-ignore
	transformer<In, Out, O1, O2, O3, O4>(
	...
	combine<T1, T2, T3>(
		...nodes: [NodeRef<T1>, NodeRef<T2>, NodeRef<T3>]
	): NodeRef<[T1, T2, T3]> // prettier-ignore
	combine<T1, T2, T3, T4>(
		...nodes: [NodeRef<T1>, NodeRef<T2>, NodeRef<T3>, NodeRef<T4>]
	): NodeRef<[T1, T2, T3, T4]> // prettier-ignore
	combine<T1, T2, T3, T4, T5>(
		...nodes: [NodeRef<T1>, NodeRef<T2>, NodeRef<T3>, NodeRef<T4>, NodeRef<T5>]
	): NodeRef<[T1, T2, T3, T4, T5]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8, T9]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14]> // prettier-ignore
	...
	): NodeRef<[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15]> // prettier-ignore
	combine<
		T1,
		T2,
		T3,
	...
	getValues<T1, T2, T3>(
		nodes: [NodeRef<T1>, NodeRef<T2>, NodeRef<T3>],
	): [T1, T2, T3] // prettier-ignore
	getValues<T1, T2, T3, T4>(
		nodes: [NodeRef<T1>, NodeRef<T2>, NodeRef<T3>, NodeRef<T4>],
	): [T1, T2, T3, T4] // prettier-ignore
	getValues<T1, T2, T3, T4, T5>(
		nodes: [NodeRef<T1>, NodeRef<T2>, NodeRef<T3>, NodeRef<T4>, NodeRef<T5>],
	): [T1, T2, T3, T4, T5] // prettier-ignore
	getValues<T1, T2, T3, T4, T5, T6>(
		nodes: [
			NodeRef<T1>,
			NodeRef<T2>,
			NodeRef<T3>,
	...
	changeWith<T, K>(
		cell: NodeRef<T>,
		source: NodeRef<K>,
		map: (cellValue: T, signalValue: K) => T,
	) {
		this.connect({
			sources: [source],
			pulls: [cell],
	...
	private calculateExecutionMap(nodes: symbol[]) {
		...
		const visit = (node: symbol, insertIndex = 0) => {
			...
			pendingPulls.use(node, (pulls) => {
				...
				insertIndex =
					Math.max(
						...Array.from(pulls).map((key) => participatingNodes.indexOf(key)),
					) + 1
			})
	...
	private getExecutionMap(nodes: symbol[]) {
		...
		if (nodes.length === 1) {
			...
			for (const [key, existingMap] of this.executionMaps.entries()) {
				if (
					Array.isArray(key) &&
					key.length === nodes.length &&
					key.every((id) => nodes.includes(id))
				) {
					return existingMap
				}
			}
	...
	private combineOperators<T, O1>(
		...o: [O<T, O1>]
	): (s: NodeRef<T>) => NodeRef<O1> // prettier-ignore
	private combineOperators<T, O1, O2>(
		...o: [O<T, O1>, O<O1, O2>]
	): (s: NodeRef<T>) => NodeRef<O2> // prettier-ignore
	private combineOperators<T, O1, O2, O3>(
		...o: [O<T, O1>, O<O1, O2>, O<O2, O3>]
	): (s: NodeRef<T>) => NodeRef<O3> // prettier-ignore
	private combineOperators<T, O1, O2, O3, O4>(
		...o: [O<T, O1>, O<O1, O2>, O<O2, O3>, O<O3, O4>]
	): (s: NodeRef<T>) => NodeRef<O4> // prettier-ignore
	private combineOperators<T, O1, O2, O3, O4, O5>(
		...o: [O<T, O1>, O<O1, O2>, O<O2, O3>, O<O3, O4>, O<O4, O5>]
	): (s: NodeRef<T>) => NodeRef<O5> // prettier-ignore
	private combineOperators<T, O1, O2, O3, O4, O5, O6>(
		...o: [O<T, O1>, O<O1, O2>, O<O2, O3>, O<O3, O4>, O<O4, O5>, O<O5, O6>]
	): (s: NodeRef<T>) => NodeRef<O6> // prettier-ignore
	...
	): (s: NodeRef<T>) => NodeRef<O7> // prettier-ignore
	private combineOperators<T>(
		...o: Array<O<unknown, unknown>>
	): (s: NodeRef<T>) => NodeRef<unknown>
	private combineOperators<T>(
		...o: Array<O<unknown, unknown>>
	): (s: NodeRef<T>) => NodeRef<unknown> {
